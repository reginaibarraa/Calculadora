...
public class MiCalculadora {
    ...
    public static boolean revisaSintaxis(String operacion){
        boolean resp = false;
        operacion = enNegativo(operacion);
        if(MiCalculadora.noOperadorFinal(operacion))
            if(MiCalculadora.noOperadorInicio(operacion))
                if(MiCalculadora.noOperadoresJuntos(operacion))
                    if(MiCalculadora.noParentesisVacios(operacion))
                        if(MiCalculadora.revisaParentesis(operacion))
                            if(MiCalculadora.revisaPuntosDecimales(operacion))
                                resp = true;
    ...
    public static ArrayList<String> infijaPostfija(String operacionInfija){
        ...
        if(MiCalculadora.revisaSintaxis(operacionInfija)){
    ...
    String operacion= "(-5-5)*4-(-89-1)";
        ...
        String operacion2= "(-6)*(-6)";

        System.out.println(enNegativo(operacion2));
        System.out.println(infijaPostfija(operacion2));
